...
| B20 | Proposal review UI + exports apply cuts/zooms via `timemap` (browser + cloud) + parity fixtures | A17, A19, A20, B18, B19 | done pending verification (merging: shared crop-window curve, Passes tab, split lanes, crop parity; B20b: keyframe tracks, EditPassItem drag, markers/overlays/scrub) |
