...
This page grows across M20's increments; the LLM section below is complete as
of increment 2b. The auth/no-key-UI sections land in increment 4, the full
start-command walkthrough in increment 5.
...
<!-- Increments 3-5 add: auto-verify dev signup, no-key UI (Google
login/billing/admin credits), and the full start-command walkthrough. -->
