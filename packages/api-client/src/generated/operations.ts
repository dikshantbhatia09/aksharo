...
export const API_OPERATIONS = [
  ...
  },
  {
    ...
    method: "GET",
    path: "/admin/affiliates/{affiliateId}/form16a",
    tags: ["admin"],
  ...
  },
  {
    ...
    method: "GET",
    path: "/admin/affiliates/tds/{fyLabel}/export.csv",
    tags: ["admin"],
  ...
  },
  {
    ...
    method: "DELETE",
    path: "/admin/routing/weights/{laneId}/{provider}",
    tags: ["admin"],
  ...
  },
  {
    ...
    path: "/admin/flags",
    tags: ["admin"],
    summary: "Create a flag (superadmin only)",
  },
  {
    ...
    tags: ["admin"],
    summary: "Delete a flag (superadmin only)",
  },
  {
    operationId: "adminDunningMonitor",
    method: "GET",
    path: "/admin/billing/dunning",
    tags: ["admin"],
  ...
  },
  {
    ...
    tags: ["admin"],
    summary: "Per-queue counts by status",
  },
  {
  ...
  },
  {
    ...
    method: "GET",
    path: "/admin/referrals/review-queue",
    tags: ["admin"],
  ...
  },
  {
    ...
    method: "POST",
    path: "/admin/billing/passes/{passPurchaseId}/refund",
    tags: ["admin"],
    summary: "Refund a pass/top-up purchase under the 7-day-full / pro-rata policy, and issue a credit note",
  },
  {
  ...
  {
    operationId: "adminRejectReferralHold",
    method: "POST",
  ...
  },
  {
    ...
    method: "POST",
    path: "/admin/credits/reverse",
    tags: ["admin"],
    summary: "Reverse a settled job's credit charge back onto the workspace (finance/superadmin only)",
  },
  {
  ...
  },
  {
    ...
    path: "/admin/users",
    tags: ["admin"],
    summary: "Search users by email/name",
  },
  {
    operationId: "adminSearchWorkspaces",
    method: "GET",
    path: "/admin/workspaces",
    tags: ["admin"],
    summary: "Search workspaces by name/slug",
  },
  {
  ...
  },
  {
    ...
    method: "POST",
    path: "/projects/{projectId}/passes/sfx",
    tags: ["passes"],
