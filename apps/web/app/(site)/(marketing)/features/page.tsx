...
export const metadata: Metadata = {
  title: "Features",
  description:
    "Every value proposition, explained: measured Hinglish accuracy, word-level editing, tunable caption styling, autocut and zoom passes, subtitle exports and India-first pricing.",
