...
COMMENT ON COLUMN edg_segments.seq IS
  'Base-62 fractional index for document ordering (CONTRACTS section 2, D28); generated by seqBetween() in @montaj/edg. COLLATE "C" is required: the alphabet 0-9A-Za-z is in ASCII order so that string comparison is key comparison, which a linguistic collation would break.';
